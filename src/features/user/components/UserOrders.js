    ...
    <div>
      {orders.map(order=>(
        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          ...
          <div className="flex justify-between gap-x-6 px-5 py-5 mt-4 border-solid border-2 border-gray-200">
          ...
          <div className="min-w-0 flex-auto">
              ...
              <p className="mt-1 truncate text-xs leading-5 text-gray-500">{order.selectedAddress.city} , ({order.selectedAddress.pinCode}),</p>
          ...
          <div className="hidden sm:flex sm:flex-col sm:items-end">
            ...
            <p className="text-sm leading-6 text-gray-900">Email id :  {order.selectedAddress.email}</p>

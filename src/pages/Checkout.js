...
import { deleteItemFromCartAsync, updateCartAsync, selectItems } from "../features/cart/cartSlice";
...
function Checkout() {
  ...
  const handleOrder = (e) => {
    ...
    const order = {items, totalAmount, totalItems, user:user.id, paymentMethod, selectedAddress, status: 'pending' //other status can be delivered, recieved.
  };
  ...
  // TODO : Redirect to order_success page
      ...
      {user.addresses.map((address,index) => (
        <li key={index} className="flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-200">
          ...
          <div className="hidden sm:flex sm:flex-col sm:items-end">
            <p className="text-sm leading-6 text-gray-900">Phone No. :  {address.phone}</p>
            <p className="text-sm leading-6 text-gray-900">Email id :  {address.email}</p>
                  ...
                  <div className="ml-4 flex flex-1 flex-col">
                    ...
                    <div className="flex flex-1 items-end justify-between text-sm">
                      <div className="text-gray-500">
                        <label
                          htmlFor="quantity"
                          className="inlline mr-5 text-sm font-medium leading-6 text-gray-900"
                        >
                          Qty
                        </label>
